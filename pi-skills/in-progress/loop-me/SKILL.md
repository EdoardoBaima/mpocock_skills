...
Run a stateful `/skill:grilling` session whose only output is **workflow** specs. Use the grilling discipline: be relentless, ask one round of questions at a time, and attach a recommended answer to each question. Aim it at the vocabulary and goal below. Create, edit, and delete specs as the grilling resolves things.
