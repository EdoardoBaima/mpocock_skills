...
It asks **one question at a time** and waits for your answer before the next — never a bulk list, which is bewildering. Each question comes with the agent's own recommended answer. It looks up facts the codebase can settle, but it brings decisions back to you and waits for your answer. It won't start enacting the plan until you confirm the shared understanding has been reached.
