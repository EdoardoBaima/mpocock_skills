...
Copy `pi-skills/productivity/to-questionnaire` into your pi skills directory, then reload pi.

```bash
mkdir -p ~/.pi/agent/skills
cp -R pi-skills/productivity/to-questionnaire ~/.pi/agent/skills/
```

Invoke it as `/skill:to-questionnaire`.

[Pi-adapted source](../../productivity/to-questionnaire/SKILL.md)

[Upstream source](https://github.com/mattpocock/skills/tree/main/skills/productivity/to-questionnaire)
...
- **Who is it going to?** Give their role, expertise and relationship to you. Confirm how the questionnaire should name the sender. This sets the tone and the context the document must carry.
- **What do you need back?** List the decisions or facts you cannot resolve alone. State how you will use the answers, the deadline and a realistic effort estimate. The skill reuses details already in the conversation instead of asking twice.
