...
Copy `pi-skills/productivity/writing-great-skills` into your pi skills directory, then reload pi.

```bash
mkdir -p ~/.pi/agent/skills
cp -R pi-skills/productivity/writing-great-skills ~/.pi/agent/skills/
```

Invoke it as `/skill:writing-great-skills`.

[Pi-adapted source](../../productivity/writing-great-skills/SKILL.md)

[Upstream source](https://github.com/mattpocock/skills/tree/main/skills/productivity/writing-great-skills)
...
- **Failure modes** — **premature completion**, **duplication**, **sediment**, **sprawl**, **no-op**, and **negation** — to diagnose a skill that isn't behaving.
