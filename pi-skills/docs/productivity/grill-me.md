...
Copy `pi-skills/productivity/grill-me` into your pi skills directory, then reload pi.

```bash
mkdir -p ~/.pi/agent/skills
cp -R pi-skills/productivity/grill-me ~/.pi/agent/skills/
```

Invoke it as `/skill:grill-me`.

[Pi-adapted source](../../productivity/grill-me/SKILL.md)

[Upstream source](https://github.com/mattpocock/skills/tree/main/skills/productivity/grill-me)
