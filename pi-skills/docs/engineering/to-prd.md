...
Copy `pi-skills/engineering/to-prd` into your pi skills directory, then reload pi.

```bash
mkdir -p ~/.pi/agent/skills
cp -R pi-skills/engineering/to-prd ~/.pi/agent/skills/
```

Invoke it as `/skill:to-prd`.

[Pi-adapted source](../../engineering/to-prd/SKILL.md)

[Upstream source](https://github.com/mattpocock/skills/tree/main/skills/engineering/to-prd)
...
You invoke this by typing `/skill:to-prd` — the agent won't reach for it on its own.
