...
Copy `pi-skills/engineering/prototype` into your pi skills directory, then reload pi.

```bash
mkdir -p ~/.pi/agent/skills
cp -R pi-skills/engineering/prototype ~/.pi/agent/skills/
```

Invoke it as `/skill:prototype`.

[Pi-adapted source](../../engineering/prototype/SKILL.md)

[Upstream source](https://github.com/mattpocock/skills/tree/main/skills/engineering/prototype)
