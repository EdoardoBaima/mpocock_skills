...
Copy `pi-skills/engineering/to-spec` into your pi skills directory, then reload pi.

```bash
mkdir -p ~/.pi/agent/skills
cp -R pi-skills/engineering/to-spec ~/.pi/agent/skills/
```

Invoke it as `/skill:to-spec`.

[Pi-adapted source](../../engineering/to-spec/SKILL.md)

[Upstream source](https://github.com/mattpocock/skills/tree/main/skills/engineering/to-spec)
