...
Copy `pi-skills/engineering/codebase-design` into your pi skills directory, then reload pi.

```bash
mkdir -p ~/.pi/agent/skills
cp -R pi-skills/engineering/codebase-design ~/.pi/agent/skills/
```

Invoke it as `/skill:codebase-design`.

[Pi-adapted source](../../engineering/codebase-design/SKILL.md)

[Upstream source](https://github.com/mattpocock/skills/tree/main/skills/engineering/codebase-design)
