...
Copy `pi-skills/engineering/wayfinder` into your pi skills directory, then reload pi.

```bash
mkdir -p ~/.pi/agent/skills
cp -R pi-skills/engineering/wayfinder ~/.pi/agent/skills/
```

Invoke it as `/skill:wayfinder`.

[Pi-adapted source](../../engineering/wayfinder/SKILL.md)

[Upstream source](https://github.com/mattpocock/skills/tree/main/skills/engineering/wayfinder)
...
- Naming the **destination** is the first act because it fixes the scope every ticket is measured against. Do this before any ticket exists.
