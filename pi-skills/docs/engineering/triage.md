...
Copy `pi-skills/engineering/triage` into your pi skills directory, then reload pi.

```bash
mkdir -p ~/.pi/agent/skills
cp -R pi-skills/engineering/triage ~/.pi/agent/skills/
```

Invoke it as `/skill:triage`.

[Pi-adapted source](../../engineering/triage/SKILL.md)

[Upstream source](https://github.com/mattpocock/skills/tree/main/skills/engineering/triage)
