...
Show this to the user, then immediately proceed to Step 2. The user reads and thinks while alternatives are produced.
...
Use a separate technical brief for each alternative (file paths, coupling details, dependency category from [DEEPENING.md](DEEPENING.md), what sits behind the seam). The brief is independent of the user-facing problem-space explanation in Step 1. Give each alternative a different design constraint:
