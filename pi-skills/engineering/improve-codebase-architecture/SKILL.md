...
Once the user picks a candidate, run the `/skill:grilling` skill to walk the decision tree with them. Cover constraints, dependencies, the shape of the deepened module, what sits behind the seam, and what tests survive.
