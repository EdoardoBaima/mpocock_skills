...
```bash
node .pi/skills/skills-inventory-report/scripts/skills-inventory-report.mjs
```
...
```bash
node .pi/skills/skills-inventory-report/scripts/skills-inventory-report.mjs --no-open
node .pi/skills/skills-inventory-report/scripts/skills-inventory-report.mjs --output docs/custom-report.html
```
